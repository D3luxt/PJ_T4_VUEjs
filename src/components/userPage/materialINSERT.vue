    ...
    <section class="w-full h-screen">
        <div class="text-center grid grid-cols-2 gap-4 justify-center flex flex-col pr-20 pl-20">
            ...
            <div class="col-start-2">
                ...
                <form ref="uploadForm" @submit.prevent="confirmUpdate()">
                    ...
                    <div class="form-control">
                        ...
                        <input v-model="mat_gradeA" id="mat_gradeA" name="mat_gradeA" type="number"
                            placeholder="ราคาเกรด A" />
                    </div>
                    <div class="form-control">
                        <label for="ราคาเกรด B">ราคาเกรด B</label>
                        <input v-model="mat_gradeB" id="mat_gradeB" name="mat_gradeB" type="number"
                            placeholder="ราคาเกรด B" />
                    </div>
                    <div class="form-control">
                        <label for="ราคาเกรด C">ราคาเกรด C</label>
                        <input v-model="mat_gradeC" id="mat_gradeC" name="mat_gradeC" type="number"
